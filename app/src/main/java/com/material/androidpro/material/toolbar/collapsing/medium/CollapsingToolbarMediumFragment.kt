package com.material.androidpro.material.toolbar.collapsing.medium
...
import com.material.androidpro.databinding.FragmentCollapsingToolbarMediumBinding
import com.material.sharedcode.utils.AppUtils

class CollapsingToolbarMediumFragment : Fragment(), ProfileCallback {

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        val binding: FragmentCollapsingToolbarMediumBinding = DataBindingUtil.inflate(inflater,
            R.layout.fragment_collapsing_toolbar_medium, container, false)
